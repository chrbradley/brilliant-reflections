...
Open, Analyze and think hard about the file @planning/spec.md.
Generate a detailed and well-structured PRD based on the spec file located at @planning/spec.md:
...
output the prd to @planning/prd.md.
